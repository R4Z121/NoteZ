  ...
  return (
    <div className="p-2">
      <div className="p-1 flex items-center gap-2 bg-app-gray rounded">
        ...
        <input type="text" placeholder="Search Note" className="border-none outline-0 p-1 bg-transparent w-full text-base sm:text-xl" onChange={searchHandler} value={searchValue} />
      </div>
    </div>
  )
}
