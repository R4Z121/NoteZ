  ...
  return (
    <div id="card-header" className="p-3">
      <div className="flex justify-between items-center gap-2">
        <h3 className="font-bold overflow-hidden text-ellipsis whitespace-nowrap sm:text-2xl text-lg">{info.title}</h3>
        <div className="flex gap-2">
          <button type="button" className="bg-transparent border-none outline-none hover:cursor-pointer" onClick={() => deleteHandler(info.id)}>
